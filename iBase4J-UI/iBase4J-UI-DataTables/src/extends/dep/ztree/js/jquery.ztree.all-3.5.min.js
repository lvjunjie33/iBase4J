...
(function (k) {
    var E, F, G, H, I, J, r = {}, K = {}, s = {}, L = {
        ...
        v = [function (b) {
            ...
            var a = b.target, c = h.getSetting(b.data.treeId), d = "", f = null, g = "", l = "", i = null, o = null, p = null;
            if (j.eqs(b.type, "mousedown"))l = "mousedown"; else if (j.eqs(b.type, "mouseup"))l = "mouseup"; else if (j.eqs(b.type, "contextmenu"))l = "contextmenu"; else if (j.eqs(b.type, "click"))if (j.eqs(a.tagName, "span") && a.getAttribute("treeNode" +
                    e.id.SWITCH) !== null)d = (k(a).parent("li").get(0) || k(a).parentsUntil("li").parent().get(0)).id, g = "switchNode"; else {
                if (p = j.getMDom(c, a, [{
                        tagName: "a",
    ...
    F = function (b, a) {
        var c = h.getSetting(b.data.treeId), d = c.view.autoCancelSelected && b.ctrlKey && h.isSelectedNode(c, a) ? 0 : c.view.autoCancelSelected && b.ctrlKey && c.view.selectedMulti ? 2 : 1;
    ...
    J = function (b, a) {
        var c = h.getSetting(b.data.treeId);
        j.apply(c.callback.beforeRightClick,
            [c.treeId, a], !0) && j.apply(c.callback.onRightClick, [b, c.treeId, a]);
    ...
    var j = {
        ...
        addNodes: function (b, a, c, d) {
            if (!b.data.keep.leaf || !a || a.isParent)if (j.isArray(c) || (c = [c]), b.data.simpleData.enable &&
                ...
                var f = k("#" + a.tId + e.id.SWITCH), g = k("#" + a.tId + e.id.ICON), l = k("#" + a.tId + e.id.UL);
            ...
            var c = [], d = k("#" + a.tId), f = k("#" + a.tId + e.id.UL), g = i.appendNodes(b, a.level + 1, a[b.data.key.children], a, !1, !0);
            ...
            var f, g;
            if (a && !a.isParent)return j.apply(d), !1; else if (a && a.isAjaxing)return !1; else if (j.apply(b.callback.beforeAsync, [b.treeId, a], !0) == !1)return j.apply(d),
                !1;
            ...
            for (var c = h.getRoot(b).curSelectedList, d = c.length - 1; d >= 0; d--)if (!a || a === c[d])if (k("#" + c[d].tId + e.id.A).removeClass(e.node.CURSELECTED), a) {
            ...
            if (c && c.length != 0) {
                var f = h.getRoot(b), g = b.data.key.children, g = !d || d.open || !!k("#" + d[g][0].tId).get(0);
                f.createdNodes = [];
            ...
            if (a) {
                ...
                if (a.open == c)j.apply(f, []); else {
                    var c = k("#" + a.tId +
                        e.id.UL), g = k("#" + a.tId + e.id.SWITCH), o = k("#" + a.tId + e.id.ICON);
        ...
        makeNodeUrl: function (b, a) {
            ...
            if (h.getNodeCache(b, a.tId)) {
                ...
                if (!b.data.keep.parent && g == 0)f.isParent = !1, f.open = !1, g = k("#" + f.tId + e.id.UL), l = k("#" + f.tId + e.id.SWITCH), j = k("#" + f.tId + e.id.ICON),
                    i.replaceSwitchClass(f, l, e.folder.DOCU), i.replaceIcoClass(f, j, e.folder.DOCU), g.css("display", "none"); else if (b.view.showLine && g > 0) {
                    var o = f[d][g - 1], g = k("#" + o.tId + e.id.UL), l = k("#" + o.tId + e.id.SWITCH);
                    j = k("#" + o.tId + e.id.ICON);
            ...
            if (a) {
                var c = k("#" + a.tId + e.id.SWITCH), d = k("#" + a.tId + e.id.UL), f = k("#" + a.tId + e.id.ICON), g = i.makeUlLineClass(b, a);
            ...
            var c = h.getNodeTitle(b, a), d = k("#" + a.tId + e.id.SPAN);
            d.empty();
            ...
            var c = k("#" + a.tId + e.id.A), d = i.makeNodeUrl(b, a);
        ...
        consts: {
            ...
            c = {
                setting: d, addNodes: function (a, b, c) {
                    ...
                    b !== !0 && b !== !1 && (b = !a.open);
                    if ((m = !!m) && b && j.apply(d.callback.beforeExpand,
                            [d.treeId, a], !0) == !1)return null; else if (m && !b && j.apply(d.callback.beforeCollapse, [d.treeId, a], !0) == !1)return null;
                ...
                getNodesByFilter: function (a, b, c, d) {
                    ...
                    if (!a)return null;
                    for (var b = d.data.key.children, c = a.parentTId ? a.getParentNode() : h.getRoot(this.setting), e = 0, i = c[b].length; e < i; e++)if (c[b][e] == a)return e;
                    return -1
                    ...
                    var a = h.getRoot(this.setting), b = a[this.setting.data.key.children];
...
(function (m) {
    ...
    p = function (c,
        ...
        var b = g.getSetting(c.data.treeId), d = b.data.key.checked;
    ...
    q = function (c, a) {
        if (a.chkDisabled === !0)return !1;
        var b = g.getSetting(c.data.treeId), d = m("#" + a.tId + i.id.CHECK);
        a.check_Focus = !0;
        e.setChkClass(b, d, a);
        return !0
    };
    ...
    m.extend(!0, m.fn.zTree._z, {
        tools: {}, view: {
            checkNodeRelation: function (c, a) {
                var b, d, h, k = c.data.key.children, j = c.data.key.checked;
                b = i.radio;
                if (c.check.chkStyle == b.STYLE) {
                    var f = g.getRadioCheckedList(c);
                    if (a[j])if (c.check.radioType == b.TYPE_ALL) {
                    ...
                    } else if (c.check.radioType == b.TYPE_ALL)for (d = 0, h = f.length; d < h; d++)if (a == f[d]) {
                        f.splice(d, 1);
                        break
                    }
                ...
                var b = c.data.key.checked, d = i.checkbox, h = i.radio, k = "", k = a.chkDisabled === !0 ? d.DISABLED : a.halfCheck ? d.PART : c.check.chkStyle == h.STYLE ? a.check_Child_State < 1 ? d.FULL : d.PART : a[b] ? a.check_Child_State === 2 || a.check_Child_State === -1 ? d.FULL : d.PART : a.check_Child_State < 1 ? d.FULL : d.PART, b = c.check.chkStyle + "_" + (a[b] ? d.TRUE : d.FALSE) +
                    "_" + k, b = a.check_Focus && a.chkDisabled !== !0 ? b + "_" + d.FOCUS : b;
                return i.className.BUTTON + " " + d.DEFAULT + " " + b
            }, repairAllChk: function (c, a) {
                if (c.check.enable && c.check.chkStyle === i.checkbox.STYLE)for (var b = c.data.key.checked, d = c.data.key.children, h = g.getRoot(c), k = 0, j = h[d].length; k < j; k++) {
                    var f = h[d][k];
                ...
                if (a) {
                    ...
                    if (a[h] && d)for (var k = 0, j = a[h].length; k < j; k++)e.repairSonChkDisabled(c, a[h][k], b, d)
                }
                ...
                var h = c.data.key.children, k = c.data.key.checked, j = m("#" + a.tId + i.id.CHECK);
                d || (d = a);
                g.makeChkFlag(c, a);
                a.nocheck !== !0 && a.chkDisabled !== !0 && (a[k] = b, e.setChkClass(c, j, a), c.check.autoCheckTrigger && a != d && c.treeObj.trigger(i.event.CHECK,
                    [null, c.treeId, a]));
                if (a.parentTId) {
                    j = !0;
                    if (!b)for (var h = a.getParentNode()[h], f = 0, o = h.length; f < o; f++)if (h[f].nocheck !== !0 && h[f].chkDisabled !== !0 && h[f][k] || (h[f].nocheck === !0 || h[f].chkDisabled === !0) && h[f].check_Child_State > 0) {
                        j = !1;
                        break
                    }
                ...
                if (a) {
                    ...
                    d || (d = a);
                    var f = !1;
                    if (a[h])for (var o = 0, l = a[h].length; o < l && a.chkDisabled !== !0; o++) {
                        var n = a[h][o];
            ...
            getRadioCheckedList: function (c) {
                ...
                return b
                                      ...
                                      a) {
                if (a) {
                    var b = c.data.key.children, d = c.data.key.checked, h = -1;
                    if (a[b])for (var e = 0, j = a[b].length; e < j; e++) {
                        var f = a[b][e], g = -1;
                        if (c.check.chkStyle == i.radio.STYLE)if (g = f.nocheck === !0 || f.chkDisabled === !0 ? f.check_Child_State : f.halfCheck === !0 ? 2 : f[d] ? 2 : f.check_Child_State > 0 ? 2 : 0, g == 2) {
                            h = 2;
                            break
                        } else g == 0 && (h = 0); else if (c.check.chkStyle == i.checkbox.STYLE)if (g = f.nocheck === !0 || f.chkDisabled === !0 ? f.check_Child_State : f.halfCheck === !0 ? 1 : f[d] ? f.check_Child_State === -1 || f.check_Child_State === 2 ? 2 : 1 : f.check_Child_State >
                            0 ? 1 : 0, g === 1) {
                            h = 1;
                            break
    ...
    var n = m.fn.zTree, l = n._z.tools, i = n.consts, e = n._z.view, g = n._z.data;
    g.exSetting(v);
    ...
    g.addInitNode(function (c, a, b, d) {
        if (b) {
            ...
            c.check.chkStyle == i.radio.STYLE && c.check.radioType == i.radio.TYPE_ALL && b[a] && g.getRoot(c).radioCheckedList.push(b)
        }
    });
    g.addInitProxy(function (c) {
        var a = c.target, b = g.getSetting(c.data.treeId), d = "", h = null, e = "", j = null;
        if (l.eqs(c.type, "mouseover")) {
            ...
            if (b.check.enable && l.eqs(a.tagName, "span") && a.getAttribute("treeNode" + i.id.CHECK) !== null)d = a.parentNode.id,
                e = "mouseoutCheck"
        } else if (l.eqs(c.type, "click") && b.check.enable && l.eqs(a.tagName, "span") && a.getAttribute("treeNode" + i.id.CHECK) !== null)d = a.parentNode.id, e = "checkNode";
        ...
        return {stop: !1, node: h, nodeEventType: e, nodeEventCallback: j, treeEventType: "", treeEventCallback: null}
    });
    ...
    g.addBeforeA(function (c, a, b) {
        c.check.enable &&
        (g.makeChkFlag(c, a), b.push("<span ID='", a.tId, i.id.CHECK, "' class='", e.makeChkClass(c, a), "' treeNode", i.id.CHECK, a.nocheck === !0 ? " style='display:none;'" : "", "></span>"))
    });
    g.addZTreeTools(function (c, a) {
        a.checkNode = function (a, b, g, j) {
            var f = this.setting.data.key.checked;
            if (a.chkDisabled !== !0 && (b !== !0 && b !== !1 && (b = !a[f]), j = !!j, (a[f] !== b || g) && !(j && l.apply(this.setting.callback.beforeCheck, [this.setting.treeId, a], !0) == !1) && l.uCanDo(this.setting) && this.setting.check.enable && a.nocheck !== !0))a[f] = b, b = m("#" +
                a.tId + i.id.CHECK), (g || this.setting.check.chkStyle === i.radio.STYLE) && e.checkNodeRelation(this.setting, a), e.setChkClass(this.setting, b, a), e.repairParentChkClassWithSelf(this.setting, a), j && c.treeObj.trigger(i.event.CHECK, [null, c.treeId, a])
        };
...
(function (k) {
            ...
            function c(b) {
                ...
                if (z.dragFlag == 0) {
                    ...
                    if (m.length > 1) {
                        ...
                        l = [];
                        for (a = 0, c = s.length; a < c; a++)if (z.dragNodeShowBefore[s[a].tId] !== void 0 && (f && j > -1 && j + 1 !== a && (f = !1), l.push(s[a]), j = a), m.length === l.length) {
                            m = l;
                            break
                        }
                    }
                    ...
                    for (a = 0, c = m.length; a < c; a++)if (f = m[a], f.editNameFlag = !1, e.selectNode(g, f, a > 0), e.removeTreeDom(g, f), j = k("<li id='" + f.tId + "_tmp'></li>"), j.append(k("#" + f.tId + d.id.A).clone()), j.css("padding", "0"), j.children("#" + f.tId + d.id.A).removeClass(d.node.CURSELECTED), y.append(j), a == g.edit.drag.maxShowNodeNum - 1) {
                ...
                if (z.dragFlag == 1) {
                    ...
                    i = g;
                    f = p.getSettings();
                    for (var B in f)if (f[B].treeId && f[B].edit.enable && f[B].treeId != g.treeId && (b.target.id == f[B].treeId || k(b.target).parents("#" + f[B].treeId).length > 0))G = !0, i = f[B];
                    B = x.scrollTop();
                    j = x.scrollLeft();
                    l = i.treeObj.offset();
                    ...
                    var s = o < g.edit.drag.borderMax &&
                        o > g.edit.drag.borderMin, I = n < g.edit.drag.borderMax && n > g.edit.drag.borderMin, C = H < g.edit.drag.borderMax && H > g.edit.drag.borderMin, o = c > g.edit.drag.borderMin && o > g.edit.drag.borderMin && n > g.edit.drag.borderMin && H > g.edit.drag.borderMin, n = l && i.treeObj.scrollTop() <= 0, H = s && i.treeObj.scrollTop() + i.treeObj.height() + 10 >= a, M = I && i.treeObj.scrollLeft() <= 0, N = C && i.treeObj.scrollLeft() + i.treeObj.width() + 10 >= f;
                    if (b.target.id && i.treeObj.find("#" + b.target.id).length > 0) {
                        ...
                        var O = !0;
                        for (a = 0, c = m.length; a < c; a++)if (f = m[a], A.id === f.tId) {
                            O = !1;
                            break
                ...
                if (z.dragFlag != 0) {
                    ...
                    if (r) {
                        ...
                        if (h.apply(g.callback.beforeDrop, [i.treeId, m, n, v, o], !0) != !1) {
                            ...
                            a = function () {
                                if (G) {
                                    if (!o)for (var a = 0, c = m.length; a < c; a++)e.removeNode(g, m[a]);
                                    if (v == d.move.TYPE_INNER)e.addNodes(i, n, s); else if (e.addNodes(i,
                                            n.getParentNode(), s), v == d.move.TYPE_PREV)for (a = 0, c = s.length; a < c; a++)e.moveNode(i, n, s[a], v, !1); else for (a = -1, c = s.length - 1; a < c; c--)e.moveNode(i, n, s[c], v, !1)
                                } else if (o && v == d.move.TYPE_INNER)e.addNodes(i, n, s); else if (o && e.addNodes(i, n.getParentNode(), s), v != d.move.TYPE_NEXT)for (a = 0, c = s.length; a < c; a++)e.moveNode(i, n, s[a], v, !1); else for (a = -1, c = s.length - 1; a < c; c--)e.moveNode(i, n, s[c], v, !1);
    ...
    k.extend(!0, k.fn.zTree._z, {
        tools: {
            getAbs: function (b) {
                ...
                if (a)for (var d = k("iframe"), f = 0, e = d.length; f < e; f++) {
                    var j = d.get(f), g = h.getAbs(j), j = k("<div id='zTreeMask_" + f + "' class='zTreeMask' style='top:" + g[1] + "px; left:" + g[0] + "px; width:" + j.offsetWidth + "px; height:" + j.offsetHeight + "px;'></div>");
                    j.appendTo("body");
            ...
            addEditBtn: function (b, a) {
                if (!(a.editNameFlag || k("#" + a.tId + d.id.EDIT).length > 0) && h.apply(b.edit.showRenameBtn, [b.treeId, a], b.edit.showRenameBtn)) {
                    var c = k("#" + a.tId + d.id.A), q = "<span class='" + d.className.BUTTON +
                        ...
                        " edit' id='" + a.tId + d.id.EDIT + "' title='编辑'" + d.id.EDIT + " style='display:none;'></span>";
                    c.append(q);
                ...
                if (!(a.editNameFlag || k("#" + a.tId + d.id.REMOVE).length > 0) && h.apply(b.edit.showRemoveBtn, [b.treeId, a], b.edit.showRemoveBtn)) {
                    var c = k("#" + a.tId +
                        //d.id.A), q = "<span class='" + d.className.BUTTON + " remove' id='" + a.tId + d.id.REMOVE + "' title='" + h.apply(b.edit.removeTitle, [b.treeId, a], b.edit.removeTitle) + "' treeNode" + d.id.REMOVE + " style='display:none;'></span>";
                        d.id.A), q = "<span class='" + d.className.BUTTON + " remove' id='" + a.tId + d.id.REMOVE + "' title='删除' style='display:none;'></span>";
                    c.append(q);
                ...
                var c = p.getRoot(b), q = b.data.key.name, f = c.curEditNode;
                if (f) {
                    var l = c.curEditInput, j = a ? a : l.val();
                    if (!a && h.apply(b.callback.beforeRename, [b.treeId, f, j], !0) === !1)return !1; else f[q] = j ? j : l.val(), a || b.treeObj.trigger(d.event.RENAME, [b.treeId, f]);
            ...
            removeTreeDom: function (b, a) {
                ...
                if (c !== a.level) {
                    var b = k("#" + a.tId), e = k("#" + a.tId + d.id.A), f = k("#" + a.tId + d.id.UL), c = d.className.LEVEL + c, a = d.className.LEVEL + a.level;
                    b.removeClass(c);
                    b.addClass(a);
                    e.removeClass(c);
                    e.addClass(a);
    ...
    var E = k.fn.zTree, h = E._z.tools, d = E.consts, e = E._z.view, p = E._z.data;
    p.exSetting({
        edit: {
            enable: !1,
            editNameSelectAll: !1,
    ...
    p.addInitProxy(function (b) {
        var a = b.target, c = p.getSetting(b.data.treeId), e = b.relatedTarget, f = "", l = null, j = "", g = null, k = null;
    ...
    p.addZTreeTools(function (b, a) {
        a.cancelEditName = function (a) {
            var d = p.getRoot(b), f = b.data.key.name, h = d.curEditNode;
        ...
        a.moveNode = function (a, q, f, l) {
            ...
            if (!q)return q;
            if (a && !a.isParent && b.data.keep.leaf && f === d.move.TYPE_INNER)return null; else if (a && (q.parentTId == a.tId && f == d.move.TYPE_INNER || k("#" + q.tId).find("#" + a.tId).length > 0))return null; else a || (a = null);
            h.canAsync(b,
    ...
    e.cancelPreSelectedNode = function (b, a) {
        for (var c = p.getRoot(b).curSelectedList, d = 0, f = c.length; d < f; d++)if (!a || a === c[d])if (e.removeTreeDom(b, c[d]), a)break;
